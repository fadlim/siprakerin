...
error_reporting(E_ALL ^ E_NOTICE);
  ...
  $query=mysql_query("SELECT * FROM tbl_dataprakerin,mst_siswa,mst_jurusan,mst_pembsek
                                        WHERE tbl_dataprakerin.nis=mst_siswa.nis
                                        AND mst_siswa.id_jur=mst_jurusan.id_jur
                                        AND tbl_dataprakerin.id_pembsek = mst_pembsek.id_pembsek");
...
function sendValue (s){
  var id_dtprakerin = $(s).attr('id_dtprakerin');
  var nis = $(s).attr('nis');
  var nama_siswa = $(s).attr('nama_siswa'); 
  var nama_jur = $(s).attr('nama_jur'); 
  var nama_dudi = $(s).attr('nama_dudi');
  var nama_pembsek = $(s).attr('nama_pembsek'); 
  
  // alert(nis);
  window.opener.document.getElementById('id_dtprakerin').value = id_dtprakerin;
  ...
  window.opener.document.getElementById('nama_pembsek').value = nama_pembsek;
  //alert(selvalue);
  window.close();
}
//  End -->
                ...
                <tbody>
                 <?php 
                  ...
                  <tr>
                    ...
                    <td align="center">
                    <div class="btn-group">
                      <button type="button" class="btn blue red-stripe" id_dtprakerin="<?php echo $data['id_dtprakerin']?>" nis="<?php echo $data['nis'];?>" nama_siswa="<?php echo $data['nama_siswa'];?>" nama_jur="<?php echo $data['nama_jur'];?>" nama_dudi="<?php echo $data['nama_dudi'];?>" nama_pembsek="<?php echo $data['nama_pembsek'];?>" onClick="sendValue(this);"><i class="fa fa-check-square-o fa-2x" title="select"></i></button>
                    </div>
                    </td>
                  </tr>
                  <?php
